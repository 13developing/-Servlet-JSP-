                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            <a href="/book/departServlet?action=saveOrUpdatePage" class="btn btn-success "
                               type="button"><i
                                    class="fa fa-plus"></i>&nbsp;添加</a>
                        </div>

                        <div class="col-sm-3">
                            <form action="/book/departServlet" method="get" id="myForm">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.pageUtils.list}" var="entity">
                                <tr>
                                    ...
                                    <td><a href="/book/departServlet?action=saveOrUpdatePage&id=${entity.id}"
        ...
        swal({
            ...
            $.get("/book/departServlet?action=remove&id=" + id, function (msg) {
                if (msg === 'ok') {
                    ...
                    //表示不可被删除
                    swal("删除失败！", "该院系已经被分配，不可删除。", "Warning");
                }
                //之后再发起一个查询操作
            })
        });
