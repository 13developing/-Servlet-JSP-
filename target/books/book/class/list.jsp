                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            <a href="/book/classesServlet?action=saveOrUpdatePage" class="btn btn-success "
                               type="button"><i
                                    class="fa fa-plus"></i>&nbsp;添加</a>
                        </div>

                        <div class="col-sm-3">
                            <form action="/book/classesServlet" method="get" id="myForm">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.pageUtils.list}" var="entity">
                                <tr>
                                    ...
                                    <td><a href="/book/classesServlet?action=saveOrUpdatePage&id=${entity.id}"
...
<script>
    ...
    function removeData(id) {
        swal({
            ...
            $.get("/book/classesServlet?action=remove&id=" + id, function (msg) {
                if (msg === 'ok') {
                    //表示删除
                    window.location.href = "/book/classesServlet?action=list"
                } else {
                    //表示不可被删除
                    swal("删除失败！", "该班级已经被分配，不可删除。", "Warning");
                }
                //之后再发起一个查询操作
            })
        });
