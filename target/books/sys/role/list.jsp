                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            <a href="/sys/roleServlet?action=saveOrUpdatePage" class="btn btn-success " type="button"><i
                                    class="fa fa-plus"></i>&nbsp;添加</a>
                        </div>

                        <div class="col-sm-3">
                            <form action="/sys/roleServlet" method="get" id="myForm">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.pageUtils.list}" var="entity">
                                <tr>
                                    ...
                                    <td><a href="/sys/roleServlet?action=saveOrUpdatePage&id=${entity.id}"
        ...
        swal({
            ...
            $.get("/sys/roleServlet?action=remove&id=" + id, function (msg) {
                if(msg==='ok'){
                    ...
                    //表示不可被删除
                    swal("删除失败！", "该角色已经被分配，不可删除。", "Warning");
                }
