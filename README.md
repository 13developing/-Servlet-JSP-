# -Servlet-JSP-
基于Servlet和JSP的学生图书管理系统
### 登录页面预览
.<img src="https://forming1picgp.oss-cn-nanjing.aliyuncs.com/img/202312071413441.png" width="800" height="450">

### 系统分为两种权限用户，即管理员和普通学生用户
#### 管理员页面
...
### 系统使用相关：
***学生的添加只能由管理员进行添加***
***学生的借书卡只可以由管理员进行生成，一个学生可以生成多张借书卡***
***管理员可以创建学院，班级以及生成，下架借书卡***

## 更多详细内容请自行探索，若系统存在bug，请海涵
