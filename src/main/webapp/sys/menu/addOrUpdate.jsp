        ...
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="/sys/menuServlet?action=saveOrUpdate"
                          method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="url" name="url" class="form-control" type="text" value="${entity.url}"
                                       aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="seq" name="seq" class="form-control" type="number" value="${entity.seq}"
                                       aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
