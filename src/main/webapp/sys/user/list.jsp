                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            ...
                            <a href="/sys/userServlet?action=saveOrUpdatePage" class="btn btn-success " type="button"><i
                                    class="fa fa-plus"></i>&nbsp;添加</a>
                        </div>

                        <div class="col-sm-3">
                            <form action="/sys/userServlet" method="get" id="myForm">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.pageUtils.list}" var="entity">
                                <tr>
                                    ...
                                    <td><a href="/sys/userServlet?action=saveOrUpdatePage&id=${entity.id}"
...
<script>
    ...
    function removeData(id) {
        swal({
            ...
            swal("删除成功！", "您已经永久删除该用户信息。", "success");
            $.get("/sys/userServlet?action=remove&id=" + id, function (msg) {

                //之后再发起一个查询操作
                window.location.href = "/sys/userServlet?action=ListInfo"
            })
