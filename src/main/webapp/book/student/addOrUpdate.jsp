...
<head>
    ...
    <link href="/css/plugins/iCheck/custom.css" rel="stylesheet">   <!----   复选框的样式- -->
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="/book/studentServlet?action=saveOrUpdate"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="stuno" name="stuno" class="form-control" type="text" value="${entity.stuno}"
                                       aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="age" name="age" class="form-control" type="text" value="${entity.age}"
                                       aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <input type="radio" ${entity.gender=='male'?'checked':''} value="male"
                                           id="gender1" name="gender">男</label>
                                <label class="radio-inline">
                                    <input type="radio" ${entity.gender=='female'?'checked':''}value="female"
                                           id="gender2" name="gender">女</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="email" name="email" class="form-control" type="text" value="${entity.email}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" id="departId" name="departId"
                                        onchange="dispatcherClasses(this.value)">
                                    <option value="-1">-----请选择院系-----</option>
                                    <c:forEach items="${requestScope.departs}" var="depart">
                                        <option value="${depart.id}" ${depart.id==entity.departId?'selected':''}>${depart.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" name="classid" id="classesId">
