        ...
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="/book/bookServlet?action=saveOrUpdate"
                          method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" name="publish">
                                    <option value="人民文学出版社" ${entity.publish=='人民文学出版社'?'selected':''}>
                                        人民文学出版社
                                    </option>

                                    <option value="中国人民教育出版社" ${entity.publish=='中国人民教育出版社'?'selected':''}>
                                        中国人民教育出版社
                                    </option>

                                    <option value="商务印书馆" ${entity.publish=='商务印书馆'?'selected':''}>
                                        商务印书馆
                                    </option>
                                    <option value="中华书局" ${entity.publish==''?'selected':''}>中华书局</option>
                                    <option value="上海译文出版社" ${entity.publish=='上海译文出版社'?'selected':''}>
                                        上海译文出版社
                                    </option>
                                    <option value="人民邮电出版社" ${entity.publish=='人民邮电出版社'?'selected':''}>
                                        人民邮电出版社
                                    </option>
                                    <option value="机械工业出版社" ${entity.publish=='机械工业出版社'?'selected':''}>
                                        机械工业出版社
                                    </option>
                                    <option value="科学出版社" ${entity.publish=='科学出版社'?'selected':''}>
                                        科学出版社
                                    </option>
                                    <option value="三联书店" ${entity.publish=='三联书店'?'selected':''}>三联书店
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" name="typeId">
                                    <c:forEach items="${types}" var="type">
                                        <option value="${type.id}" ${type.id==entity.typeid?'selected':''}>${type.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="img" id="imgName" value="${entity.img}">
                            <label class="col-sm-3 control-label">头像：</label>
                            <div class="col-sm-8">
                                <div class="uploader-demo">
                                    <div id="fileList" class="uploader-list" value="${entity.img}"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="notes" name="notes" class="form-control" type="textarea"
                                       value="${entity.notes}"
                                       aria-required="true" aria-invalid="false" class="valid">
                            </div>
                        </div>
