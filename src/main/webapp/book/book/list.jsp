                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            <a href="/book/bookServlet?action=saveOrUpdatePage" class="btn btn-success "
                               type="button"><i
                                    class="fa fa-plus"></i>&nbsp;添加</a>
                        </div>

                        <div class="col-sm-3">
                            <form action="/book/bookServlet" method="get" id="myForm">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.pageUtils.list}" var="entity">
                                <tr>
                                    ...
                                    <td><a href="/book/bookServlet?action=saveOrUpdatePage&id=${entity.id}"
